...
describe("TicketPurchaseSummary", () => {
  test("generatePurchaseSummary creates a summary string from a single parsed ticket request", () => {
  ...
  test("generatePurchaseSummary creates a summary string from multiple parsed ticket requests of two types", () => {
  ...
  test("generatePurchaseSummary creates a summary string from multiple parsed ticket requests of three types", () => {
